<!-- Users Modal -->
<!-- نافذة منبثقة لإضافة أو تعديل المستخدمين -->
<div id="userModal" class="modal">
  <div class="modal-content">
    ...
    <!-- فورم إضافة / تعديل المستخدم -->
    <form id="userForm">

      <!-- hidden field لتحديد هل إضافة ولا تعديل -->
...
<!-- Products Modal -->
<!-- نافذة لإضافة أو تعديل المنتجات -->
<div id="productModal" class="modal">
  <div class="modal-content">
    ...
    <form id="productForm" enctype="multipart/form-data">
      ...
      <input type="number" id="product_stock" name="stock_quantity" required>
